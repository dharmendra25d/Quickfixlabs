    ...
    <header className={navClass} role="banner">
      <Container>
        ...
        >
          ...
          {/* Mobile hamburger */}
          <button
            className="md:hidden p-2 rounded-lg text-muted hover:text-primary hover:bg-slate-100 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary"
            onClick={() => setOpen((v) => !v)}
